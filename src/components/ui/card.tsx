...
const Card = React.forwardRef<
  ...
  React.HTMLAttributes<HTMLDivElement> & {
    variant?: "default" | "elevated" | "glass" | "match"
  }
>(({ className, variant = "default", ...props }, ref) => {
  const variants = {
    ...
    glass: "glass-card",
    match: "bg-card text-card-foreground shadow-card border-2 border-primary/10 hover:border-primary/30 transition-colors",
  }
